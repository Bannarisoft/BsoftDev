...
namespace WarehouseManagement.Infrastructure.Repositories.BinMaster
{
    public class BinMasterCommandRepository : IBinMasterCommandRepository
    {
        ...
        public async Task<int> CreateAsync(Core.Domain.Entities.BinMaster binMaster)
        {
            await _dbContext.BinMasters.AddAsync(binMaster);
            await _dbContext.SaveChangesAsync();
            return binMaster.Id;
        }
        public async Task<int> UpdateAsync(Core.Domain.Entities.BinMaster binMaster, CancellationToken ct = default)
        {
        ...
        public async Task<Core.Domain.Entities.BinMaster?> GetByIdAsync(int id, CancellationToken ct = default)
        {
        ...
        public async Task<int> DeleteAsync(int id, CancellationToken ct = default)
        {
            ...
            entity.IsActive = Core.Domain.Common.BaseEntity.Status.Inactive; // usually mark inactive too            

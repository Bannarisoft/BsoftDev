...
namespace InventoryManagement.Infrastructure.Repositories.UOMConversion
{
    public class UOMConversionCommandRepository : IUOMConversionCommandRepository
    {
        ...
        public async Task<Core.Domain.Entities.UOMConversion> CreateAsync(Core.Domain.Entities.UOMConversion uOMConversion)
        {
        ...
        public async Task<Core.Domain.Entities.UOMConversion?> UpdateAsync(int id, Core.Domain.Entities.UOMConversion uomConversion)
        {
        ...
        public async Task<bool> DeleteAsync(int id, Core.Domain.Entities.UOMConversion uOMConversion)
        {
            var existingUOMConversion = await _dbContext.UOMConversions.FirstOrDefaultAsync(u => u.Id == id);
            if (existingUOMConversion != null)
            {

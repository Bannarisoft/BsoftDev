...
namespace InventoryManagement.Infrastructure.Repositories.HSNMaster
{
    public class HSNMasterCommandRepository : IHSNMasterCommandRepository
    {
        ...
        public async Task<int> CreateAsync(Core.Domain.Entities.HSNMaster hsnMaster)
        {
        ...
        public async Task<int> UpdateAsync(Core.Domain.Entities.HSNMaster hsnMaster)
        {
            var existingEntity = await _applicationDbContext.HSNMaster
                .FirstOrDefaultAsync(x => x.Id == hsnMaster.Id && x.IsDeleted == Core.Domain.Common.BaseEntity.IsDelete.NotDeleted);
        ...
        public async Task<bool> DeleteAsync(int id, Core.Domain.Entities.HSNMaster hsnMaster)
        {

...
namespace InventoryManagement.API.Validation.Item.ItemDetail
{
    public sealed class ItemInventoryDtoValidator : AbstractValidator<ItemInventoryDto>
    {
        public ItemInventoryDtoValidator(IMaxLengthProvider maxLen)
        {
            ...
            var batchSeriesMax = maxLen.GetMaxLength<Core.Domain.Entities.Item.ItemDetail.ItemInventory>(nameof(Core.Domain.Entities.Item.ItemDetail.ItemInventory.BatchNumberSeries)) ?? 100;
            var serialSeriesMax = maxLen.GetMaxLength<Core.Domain.Entities.Item.ItemDetail.ItemInventory>(nameof(Core.Domain.Entities.Item.ItemDetail.ItemInventory.SerialNumberSeries)) ?? 100;

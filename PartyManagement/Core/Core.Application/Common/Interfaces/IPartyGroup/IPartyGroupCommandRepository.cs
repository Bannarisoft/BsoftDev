...
namespace Core.Application.Common.Interfaces.IPartyGroup
{
    ...
    {
        Task<int> CreateAsync(Core.Domain.Entities.PartyGroup partyGroup);
        Task<bool> UpdateAsync(int Id, Core.Domain.Entities.PartyGroup partyGroup);
        Task<bool> DeleteAsync(int Id, Core.Domain.Entities.PartyGroup partyGroup);

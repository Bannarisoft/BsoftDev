...
namespace PartyManagement.Infrastructure.Repositories.PartyGroup
{
    public class PartyGroupCommandRepository : IPartyGroupCommandRepository
    {
        ...
        public async Task<int> CreateAsync(Core.Domain.Entities.PartyGroup partyGroup)
        {
        ...
        public async Task<bool> DeleteAsync(int Id, Core.Domain.Entities.PartyGroup partyGroup)
        {
        ...
        public async Task<bool> UpdateAsync(int Id, Core.Domain.Entities.PartyGroup partyGroup)
        {

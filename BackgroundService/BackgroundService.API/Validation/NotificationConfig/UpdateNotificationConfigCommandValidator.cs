...
namespace BackgroundService.API.Validation.NotificationConfig
{
    ...
    {        
        ...
        public UpdateNotificationConfigCommandValidator(MaxLengthProvider maxLengthProvider,INotificationConfigCommandRepository notificationConfigCommandRepository)
        {            

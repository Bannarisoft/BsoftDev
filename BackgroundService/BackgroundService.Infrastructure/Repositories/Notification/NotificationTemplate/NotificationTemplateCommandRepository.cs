...
namespace BackgroundService.Infrastructure.Repositories.Notification.NotificationTemplate
{
    public class NotificationTemplateCommandRepository : INotificationTemplateCommandRepository
    {
        ...
        public NotificationTemplateCommandRepository(NotificationDbContext applicationDbContext)
        {
        ...
        public async Task<bool> IsNameDuplicateAsync( int notificationConfigId, int notificationTypeId,string languageCode)
        {
